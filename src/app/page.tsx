...
export default function Main() {
  ...
  <main className={styles.main}>
    ...
    <h2 className={`${styles.main__subtitle} ${bebas.className}`}>Experience new social battle royale game</h2>
    <button className={`${styles.main__button} button`}>
      <h3 className={`${styles.main__minititle} ${openSans.className}`}>Buy Now on Steam</h3>
