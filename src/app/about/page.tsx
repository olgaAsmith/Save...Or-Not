...
export default function About() {
  return <section className={styles.about}>
    <div className={styles.about__content}>
      <h3 className={`${styles.about__subtitle} ${bebas.className}`}>What is SOS?</h3>
      <h2 className={`${styles.about__title} ${bebas.className}`}>social battle
royale game</h2>
      <div className={styles.about__line}></div>
      <p className={`${styles.about__text} text`}>Each round, you and 15 other contestants compete to
...
<p className={`${styles.about__text} text`}>Making the right decisions could be the difference between life and death.</p>
    </div>
